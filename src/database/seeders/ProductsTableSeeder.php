...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'src/storage/app/public/kiwi.png',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'src/storage/app/public/strawberry.png',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => 'src/storage/app/public/orange.png',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'src/storage/app/public/watermelon.png',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => 'src/storage/app/public/peach.png',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => 'src/storage/app/public/muscat.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => 'src/storage/app/public/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => 'src/storage/app/public/grapes.png',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => 'src/storage/app/public/banana.png',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => 'src/storage/app/public/melon.png',
